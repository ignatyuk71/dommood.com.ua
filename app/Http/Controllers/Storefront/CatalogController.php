    ...
    private function productFaq(array $product, string $categoryName): array
    {
        ...
        if (! $isOutdoorSlippers) {
            return [
                ...
                [
                    'question' => 'Скільки часу займає доставка по Україні?',
                    'answer' => 'Зазвичай відправляємо замовлення Новою поштою, а орієнтовний термін доставки становить 1-3 робочі дні залежно від міста та способу отримання.',
                ],
                [
                    'question' => 'Чи допоможе менеджер підібрати альтернативу?',
                    'answer' => 'Так, якщо потрібного варіанта немає або ви вагаєтесь із вибором, менеджер підбере схожий товар за розміром, кольором, матеріалом або бюджетом.',
                ],
            ];
        }
