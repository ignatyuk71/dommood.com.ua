...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @if (file_exists(public_path('hot')))
            @vite(['resources/css/storefront.css', 'resources/css/storefront-home.css'])
        @else
                    ...
                    <div class="container">
                        <div class="storefront-about__grid">
                            <div class="storefront-about__info">
                                ...
                                <p>
                                    DomMood — онлайн-магазин домашнього взуття та одягу з доставкою по всій Україні.
                                    В каталозі зібрано все для затишку вдома та зручних виходів надвір:
                                    <a href="{{ url('/catalog/zhinochi-pukhnasti-kaptsi') }}">жіночі пухнасті капці</a> з густим еко-хутром,
                                    <a href="{{ url('/catalog/zhinochi-kaptsi-dlia-vulytsi') }}">капці для вулиці на гумовій підошві</a>,
                                    <a href="{{ url('/catalog/zhinochi-pizhamy') }}">жіночі піжами</a> різних фасонів та кольорів,
                                    <a href="{{ url('/catalog/cholovichi-tapochky') }}">чоловічі тапочки</a>
                                    і <a href="{{ url('/catalog/dytiachi-khatni-kaptsi') }}">дитячі хатні капці</a>.
                                    Кожна категорія представлена в кількох кольорах, моделях і розмірах.
                                </p>
                                <p>
                                    Головна особливість магазину — тільки товари в наявності. Якщо модель є на сайті, вона є на складі — без виключень.
                                    Жодних позицій «під замовлення» без попередження та жодних затримок через відсутність товару.
                                    Замовлення оформлюється за кілька хвилин: оберіть модель і розмір, залиште контакти.
                                    Ми передзвонимо для підтвердження та відправимо Новою Поштою зазвичай того ж робочого дня.
                                    Доставка безкоштовна від {{ $freeShippingThresholdLabel ?? '1 200 грн' }}.
                                </p>
                                <p>
                                    Усі товари проходять перевірку якості перед відправкою.
                                    Якщо модель або розмір не підійшли — приймаємо повернення та обмін протягом 14 днів
                                    з моменту отримання, якщо товар не був у використанні.
                                </p>
                                <p>
                                    Порівнюйте моделі в <a href="{{ url('/catalog') }}">каталозі</a>, дивіться фото, ціни й наявність у реальному часі.
                                    Нові надходження в асортименті додаємо регулярно.
                                </p>
                            </div>
